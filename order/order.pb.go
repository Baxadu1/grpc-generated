...
type OrderStatusUpdate struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	OrderId       string                 `protobuf:"bytes,1,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"`
	Status        string                 `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"` // Например: "Pending", "Paid", "Shipped"
...
const file_order_order_proto_rawDesc = "" +
	...
	"\fOrderService\x12J\n" +
	"\x17SubscribeToOrderUpdates\x12\x13.order.OrderRequest\x1a\x18.order.OrderStatusUpdate0\x01B/Z-github.com/Baxadu1/grpc-generated/order;orderb\x06proto3"
